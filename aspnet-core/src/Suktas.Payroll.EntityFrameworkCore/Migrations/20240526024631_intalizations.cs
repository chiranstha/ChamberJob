    ...
    public partial class intalizations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_CompanyCategory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_CompanyType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_JobSkill", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbl_Company_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterviewDateMiti = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExperienceLevel = table.Column<int>(type: "int", nullable: false),
                    ExpiredDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpiredDateMiti = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tbl_JobDemand_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_Company_UserId",
                table: "tbl_Company",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_CompanyCategory_TenantId",
                table: "tbl_CompanyCategory",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_CompanyType_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tbl_JobDemand_UserId",
                table: "tbl_JobDemand",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_JobSkill_TenantId",
                table: "tbl_JobSkill",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_tbl_Qualification_TenantId",
